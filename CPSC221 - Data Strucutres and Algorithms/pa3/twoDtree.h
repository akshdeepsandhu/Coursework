...
private:
   ...
   * You may want a recursive helper function for this one.
   ...
   void renderHelp(PNG &im, Node* node);
   ...
   */
   ...
   void pruneHelp(Node* root, double pct, int tol);
   void countLeaves(Node* subroot, int tol,double& leaves, double& tolleaves, RGBAPixel& avg);
